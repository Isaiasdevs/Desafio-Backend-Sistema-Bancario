...
const {validarSenhaBanco, validarEmailCpf, validarDados, validarContaBanco, validardeposito, validarSaque, validarTransferencia} = require('./intermediarios/intermediarios');
